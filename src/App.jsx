  ...
  return (
    <>
      <div className="flex gap-4">
          ...
          <div className="text-center">
            ...
            <div className="flex gap-4">
              <button className="font-medium rounded-lg text-sm px-5 py-2.5" type="button" onClick={toggleDrawer}>
                {isDrawerOpen ? <FaAlignLeft /> : <FaAlignJustify />}
              </button>
              <button className="text-[#7a85ce] bg-[#e7e9f6] font-medium rounded-lg text-sm px-5 py-2.5" type="button">
                Note
              </button>
              <button className="text-[#7a85ce] bg-[#e7e9f6] font-medium rounded-lg text-sm px-5 py-2.5" type="button">
                Shipping
        ...
        <div className="flex-initial w-1/2 bg-gray-500">gfsj</div>
      </div>
